...
describe Destination do
  describe '#create_destination' do
    ...
    it "is invalid without a building_name" do
      ...
      destination.valid?
      expect(user.errors[:building_name]).to include("can't be blank")
    end

    it "is invalid without a phone_bumber" do
      destination = build(:destination, phone_bumber: nil)
      destination.valid?
      expect(user.errors[:phone_bumber]).to include("can't be blank")
    end
  end
end